...
exports.handler = async (event) => {
  ...
  try {
    ...
    SELECT o.order_id, o."customerID", u.username AS customer_name, oi.product_id, oi.quantity, s.status_id, s.status_name, o.order_date, p.product_name
    FROM orders o
...
// ==================== GET Being Serve Orders ====================
  ...
  const res = await client.query(`
    SELECT o.order_id, o."customerID", u.username AS customer_name, oi.product_id, oi.quantity, s.status_name, s.status_id, o.order_date, p.product_name
    FROM orders o
    JOIN users u ON o."customerID" = u.user_id
    JOIN order_items oi ON o.order_id = oi.order_id
    JOIN status s ON o.status_id = s.status_id
